...
class jupyterhub (
  ...
  $oauth::github_client_id         = $::jupyterhub::params::oauth_github_client_id,
  $oauth::github_client_secret     = $::jupyterhub::params::oauth_github_client_secret,
  ...
  $systemdspawner::user_workingdir = $::jupyterhub::params::systemdspawner_user_workingdir,
  $systemdspawner::default_shell   = $::jupyterhub::params::systemdspawner_default_shell,
  $systemdspawner::mem_limit       = $::jupyterhub::params::systemdspawner_mem_limit,
  $systemdspawner::cpu_limit       = $::jupyterhub::params::systemdspawner_cpu_limit,
  $systemdspawner::isolate_tmp     = $::jupyterhub::params::systemdspawner_isolate_tmp,
  $systemdspawner::isolate_devices = $::jupyterhub::params::systemdspawner_isolate_devices,
