...
class jupyterhub (
  ...
  Optional[Boolean] $jupyterhub::cfhproxy_should_start,
  ...
  Optional[Stdlib::Absolutpath] $jupyterhub::cfhproxy_command,
  ...
  Optional[String] $jupyterhub::cfhproxy_auth_token,
